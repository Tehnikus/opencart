...
(126, 'North Macedonia', 'MK', 'MKD', '', 0, 1),
...
(1, 'Euro', 'EUR', '', '€', '2', 1, 1, '2014-09-25 14:40:00');
...
DROP TABLE IF EXISTS `oc_filter_group_to_store`;
CREATE TABLE `oc_filter_group_to_store` (
  `filter_group_id` INT NOT NULL,
  `store_id`        INT NOT NULL DEFAULT '0',
  `sort_order`      INT NOT NULL DEFAULT '0',
...
CREATE TABLE `oc_product_recurring` (
  ...
  `customer_group_id` INT NOT NULL,
  `store_id`          INT NOT NULL DEFAULT '0',
  PRIMARY KEY (`product_id`,`recurring_id`,`customer_group_id`, `store_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `oc_product_to_category` (
  ...
  KEY `category_id` (`category_id`, `store_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `oc_product_to_download` (
  ...
  `download_id` INT NOT NULL,
  `store_id`    INT NOT NULL DEFAULT '0',
  PRIMARY KEY (`product_id`,`download_id`, `store_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
(0, 'config', 'config_meta_title', '{"1":"Meta title"}', 1),
(0, 'config', 'config_meta_description', '{"1":"Meta description"}', 1),
(0, 'config', 'config_meta_keyword', '{}', 1),
...
(0, 'config', 'config_icon', 'catalog/cart.svg', 0),
...
(0, 'config', 'config_address', '{"1":"Store address"}', 1),
(0, 'config', 'config_name', 'Your Store', 0),
(0, 'config', 'config_seo_url', '0', 0),
(0, 'config', 'config_file_max_size', '10000000', 0),
